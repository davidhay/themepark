package com.ealanta.themepark.controller;

import com.ealanta.themepark.entity.ThemeParkRide;
import com.ealanta.themepark.repo.ThemeParkRideRepository;
...
public class ThemeParkRideController {
  ...
  public ThemeParkRide getRide(@PathVariable long id) {
    return themeParkRideRepository.findById(id).orElseThrow(() -> new ResponseStatusException(
        HttpStatus.NOT_FOUND, String.format("Invalid ride id %s", id)));
  }
